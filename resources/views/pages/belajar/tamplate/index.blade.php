        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="mb-5">
                            <a href="{{ route('belajar.template.create') }}?tipe=html" class="btn btn-primary my-2">
                                Tambah Template HTML
                            </a>
                            <a href="{{ route('belajar.template.create') }}?tipe=js" class="btn btn-primary my-2">
                                Tambah Template JS
                            </a>
                        </div>
